...
module.exports = ({ config }) => {
  ...
  const extract = ExtractTextPlugin.extract({ use: 'css-loader?modules&localIdentName=[local]__[path][name]__[hash:base64:5]&importLoaders=1', fallback: 'style-loader', publicPath: '/build' });
